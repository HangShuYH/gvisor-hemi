...
const (
	...
	HEMI_USERSPACE_HOT_ALIAS_PROTOCOL      = 5
	...
	HEMI_USERSPACE_HOT_ALIAS_DATA_OFFSET   = HEMI_USERSPACE_HOT_ALIAS_LANE_SIZE
	HEMI_USERSPACE_HOT_ALIAS_MMAP_SIZE     = HEMI_USERSPACE_HOT_ALIAS_DATA_OFFSET + HEMI_USERSPACE_HOT_ALIAS_SLOTS*HEMI_USERSPACE_HOT_ALIAS_LANE_SIZE
)
